...
$sql = "SELECT t1.*, u.name as authorName FROM gifs t1 INNER JOIN users u ON t1.user_id = u.id INNER JOIN gifs_fav gf ON t1.id = gf.gif_id AND gf.user_id = ?";
$gifs = cache_del_data($link, $sql, [$_SESSION['user_id']], 'user_fav');
